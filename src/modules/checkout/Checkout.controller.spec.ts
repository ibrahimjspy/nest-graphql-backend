...
describe('Shop controller unit tests', () => {
  ...
  const testUserId = { userId: 'VXNlcjo1' };
  ...
  const testAddressPayload = {
    checkoutId: 'Q2hlY2tvdXQ6MjQzNTZkZTUtNTYyYS00NGM0LThhOGQtMWUyNGUyZmQwYzU2',
    addressDetails: {
      country: 'US',
      countryArea: 'FL',
      firstName: 'Umair',
  ...
  const testCheckoutId = {
    params: 'Q2hlY2tvdXQ6MjQzNTZkZTUtNTYyYS00NGM0LThhOGQtMWUyNGUyZmQwYzU2',
  };
  ...
  describe('root', () => {
    ...
    it('shoppingCart validation test', () => {
      expect(appController.getShoppingCartData(testUserId)).toBeDefined();
    });

    it('shoppingCart async test', async () => {
      const data = await appController.getShoppingCartData(testUserId);
    ...
    it('add to cart async test', async () => {
      const data = await appController.addBundlesToCart(testAddToCartPayload);
      expect(data).toEqual(objectContainingCheck(queryError));
      expect(data).toEqual(objectContainingCheck(systemError));
      expect(data).toEqual(objectContainingCheck(federationInternalError));
      expect(data).not.toHaveProperty('graphql_error');
    ...
    it('delete from cart validation test', () => {
      expect(
        appController.deleteCartBundle(testDeleteFromCartPayload),
      ).toBeDefined();
    });

    it('delete from cart async test', async () => {
      const data = await appController.deleteCartBundle(
    ...
    it('select shop from cart validation test', () => {
      expect(appController.selectThisShop(testSelectShopPayload)).toBeDefined();
    });

    it('select shop from cart async test', async () => {
      const data = await appController.selectThisShop(testSelectShopPayload);
      expect(data).toEqual(objectContainingCheck(queryError));
      expect(data).toEqual(objectContainingCheck(systemError));
      expect(data).toEqual(objectContainingCheck(federationInternalError));
      expect(data).not.toHaveProperty('graphql_error');
    ...
    it('unselect shop from cart async test', async () => {
      const data = await appController.unSelectThisShop(testSelectShopPayload);
      expect(data).toEqual(objectContainingCheck(queryError));
      expect(data).toEqual(objectContainingCheck(systemError));
      expect(data).toEqual(objectContainingCheck(federationInternalError));
      expect(data).not.toHaveProperty('graphql_error');
    ...
    it('add shiping address async test', async () => {
      const data = await appController.addShippingAddress(testAddressPayload);
      expect(data).toEqual(objectContainingCheck(queryError));
      expect(data).toEqual(objectContainingCheck(systemError));
      expect(data).toEqual(objectContainingCheck(federationInternalError));
      expect(data).not.toHaveProperty('graphql_error');
    ...
    it('add billing address validation test', () => {
      expect(appController.addBillingAddress(testAddressPayload)).toBeDefined();
    });

    it('add billing address async test', async () => {
      const data = await appController.addBillingAddress(testAddressPayload);
      expect(data).toEqual(objectContainingCheck(queryError));
      expect(data).toEqual(objectContainingCheck(systemError));
      expect(data).toEqual(objectContainingCheck(federationInternalError));
      expect(data).not.toHaveProperty('graphql_error');
    ...
    it('get shipping method validation test', () => {
      expect(appController.getShippingMethod(testUserId)).toBeDefined();
    });

    it('get shipping method async test', async () => {
      const data = await appController.getShippingMethod(testUserId);
      expect(data).toEqual(objectContainingCheck(queryError));
      expect(data).toEqual(objectContainingCheck(systemError));
      expect(data).toEqual(objectContainingCheck(federationInternalError));
      expect(data).not.toHaveProperty('graphql_error');
    ...
    it('select shipping method validation test', () => {
      expect(
        appController.selectShippingMethods(testSelectShippingMethod),
      ).toBeDefined();
    });
    ...
    it('create payment validation test', () => {
      expect(appController.createPayment(testUserId)).toBeDefined();
    });

    it('create payment async test', async () => {
      const data = await appController.createPayment(testUserId);
      expect(data).toEqual(objectContainingCheck(queryError));
      expect(data).toEqual(objectContainingCheck(systemError));
      expect(data).toEqual(objectContainingCheck(federationInternalError));
      expect(data).not.toHaveProperty('graphql_error');
    ...
    it('checkout complete validation test', () => {
      expect(appController.checkoutComplete(testUserId)).toBeDefined();
    });

    it('checkout complete async test', async () => {
      const data = await appController.checkoutComplete(testUserId);
      expect(data).toEqual(objectContainingCheck(queryError));
      expect(data).toEqual(objectContainingCheck(systemError));
      expect(data).toEqual(objectContainingCheck(federationInternalError));
      expect(data).not.toHaveProperty('graphql_error');
